...
class SemanticKitti(Dataset):
  ...
  def __getitem__(self, index):
    ...
    scan_file = self.filenames[index]
    ...
    return proj, proj_mask, proj_range, unproj_range, proj_x, proj_y, path_name
...
class Parser():
  ...
  def __init__(self,
               ...
               gt=True,           # get gt?
               shuffle_train=True,
               filenames = []):  # shuffle training set?
  ...
  def update_root(dataset_name):
    self.test_dataset = SemanticKitti(root=dataset_name,
                                        sequences=self.test_sequences,
                                        labels=self.labels,
                                        color_map=self.color_map,
                                        learning_map=self.learning_map,
